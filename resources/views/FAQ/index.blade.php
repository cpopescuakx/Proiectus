...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="tab">
            ...
            <button class="mr-1 tablinks" onclick="tabs(event, 'wiki')"><i data-toggle="tooltip" title="Gestió de blog i wiki" class="boto btn fab fa-wikipedia-w fa-lg"></i></button>
    ...
    <div class="row justify-content-center">
        <div id="gestor" class="tabcontent mt-3 col-md 6">
            <h1 class="mt-3 justify-content-center"><strong>Gestió Gestors</strong></h1>
