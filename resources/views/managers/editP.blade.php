...
@section('content')
    <div class="content formulari closed">
        <form class="was-validated" action="{{route('managers.updateP', [$managers->id])}}" method="POST">
            @csrf
                        ...
                        <div class="form-group mt-4">
                            <div class="row justify-content-center">
                                <div class="col-10 col-sm-10 col-md-8 col-lg-8 col-xl-6">
                                    ...
                                    <input type="text" name = "username" class="form-control" value = "{{$managers->username }}" id="username" required>
                                    <div class="invalid-feedback">Camp necessari</div>
                                </div>
                            </div>
                        </div>
