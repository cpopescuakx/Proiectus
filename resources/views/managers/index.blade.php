...
<div class="col">
    <div class="row d-flex justify-content-end p-4">
      ...
      <a class="mr-3" href="{{ route('managers.create') }}"><img src={{ asset('public/img/add.svg') }} width="45" height="45" alt="icona per a afegir"></a>
        ...
        @foreach($managers as $manager)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('managers.edit', $manager->id) }}"><img src={{ asset('public/img/edit.svg') }} width="20" height="20" class="mr-2" alt="icona per a editar"></a>

                    @if($manager->status == "active")
                        <a href="{{ route('managers.destroy', $manager->id) }}"><img src={{ asset('public/img/delete.svg') }} width="20" height="20" alt="icona per a eliminar"></a>
                    @endif
