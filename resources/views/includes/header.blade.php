    ...
    <div class="p-4 pt-5">
      ...
      <li class="mb-3">
        <a href="#userSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
          ...
          <img src="public/img/profile_pic/avatar_2x.png" class="foto-perfil" alt="imatge_de_perfil"><span class="mr-3"></span>{{ Auth::user()->username }}</a>
          <!-- Muestra la imagen que ha seleccionado el usuario -->
          @else
          <img class="foto-perfil" src="public/img/profile_pic/imatge{{ Auth::user()->profile_pic }}" alt="imatge_de_perfil"/><span class="mr-3"></span>{{ Auth::user()->username }}</a>
          @endif
