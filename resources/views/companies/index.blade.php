          ...
          <table class="table table-bordered" id="laravel_crud">
           ...
           <tbody>
              ...
              <tr>
                 ...
                 <td><a href="{{ route('companies.edit',$company_info->id_company)}}" class="btn btn-primary">EDITA</a></td>
                 <td>
                 <form action="{{ route('companies.destroy', $company_info->id_company)}}" method="post">
                  @csrf
                  @method('DELETE')
