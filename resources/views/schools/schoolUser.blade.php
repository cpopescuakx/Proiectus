...
@section('content')
<div class=" formulari ">
    <form class="was-validated" action="{{ route('schoolsUsers.store', Request::route('id'))}}" method="POST" autocomplete="nofill">
        @csrf
                    ...
                    <div class="container">
                        <div class="row no-gutters justify-content-center mt-5">
                            <div class="col-10 col-sm-10 col-md-8 col-lg-8 col-xl-6">
                                <h1 class="text-center">Afegir gestor d'institut</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mt-4">
                        <div class="row justify-content-center">
                            <div class="col-10 col-sm-10 col-md-8 col-lg-8 col-xl-6">
                                ...
                                <select name="user" class="selectpicker form-control mt-2" data-live-search="true" title="Escull un usuari">
